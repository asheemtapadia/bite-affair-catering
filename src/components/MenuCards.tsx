...
/* ✅ UPDATED TOTAL (MULTIPLY BY GUESTS) */
const total = cart.reduce((sum,item)=> sum + (item.price * guests),0);
    ...
    {cart.length > 0 && (
      ...
      <div className="mt-12 bg-white p-8 rounded-3xl border border-gray-100 shadow-[0_25px_80px_rgba(0,0,0,0.08)]">
        ...
        <div className="space-y-5">
          ...
          <input placeholder="Apartment, suite, etc." value={apartment} onChange={(e)=>setApartment(e.target.value)} className="w-full border p-4 rounded-xl"/>
